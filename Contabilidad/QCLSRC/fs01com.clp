...
/*-------------------------------------------------------------------*/
 ...
 VERECI:     CHGVAR     VAR(&ACCION) VALUE('C')
     ...
     /*--------------------------------------------------------*/
             CHGVAR     VAR(&TEX) VALUE('FS01CO, ANTES DE PGM-CEREFSNCL')
...
/*------------------------------------------------------------------*/
/* Proceso del CEREFSN - Acumulación de Recibos                     */
/*------------------------------------------------------------------*/
             CALL       PGM(EXPLOTA/CEREFSNCL)   +
                        PARM('FS01CO')
/*------------------------------------------------------------------*/
...
/*--                 RPG.  F S P A F A                             --*/
/*-------------------------------------------------------------------*/
             CALL       PGM(EXPLOTA/TRACE) PARM('Programa FSPAFANCL- +
                          en Ejecucion' ' ' FS01CO)
